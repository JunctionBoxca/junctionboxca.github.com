...
layout:     default
published: true
description: AWS is one of the top cloud providers. Amazon CloudFormation makes it easier to manage an entire environment and Golang is an efficient language to develop that tooling in. Combining the two and you have the foundation for building environment life-cycle.
...
<pre><code>go get -d -v github.com/awslabs/aws-sdk-go</code></pre>
